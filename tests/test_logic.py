...
class TestLogic(unittest.TestCase):
    ...
    #     mock_get_chat_response.return_value = "Let It Be - The Beatles,Shape of You - Ed Sheeran,Everlong - Foo Fighters,Bohemian Rhapsody - Queen"
    #     user_input = Playlist(event='Driving to the beach', music_genre='rock', mood='happy')
    #     result = get_new_seed_tracks_names(['track3', 'track4'], user_input)
    #     self.assertEqual(result, ['Let It Be - The Beatles', 'Shape of You - Ed Sheeran', 'Everlong - Foo Fighters', 'Bohemian Rhapsody - Queen'])
    #
    # @patch('src.logic.logic.SpotifyAPIClass.query_api')
    ...
    #     user_input = Playlist(event='Driving to the beach', music_genre='rock', mood='happy')
    #     result = find_min_num_of_tracks_with_spotify_seeds(43, params_dict, spotify, user_input)
    ...
    #
    # @patch('src.logic.logic.SpotifyAPIClass.search_item')
    # @patch('src.logic.logic.SpotifyAPIClass.get_playlist_songs')
    ...
    #     user_input = Playlist(event='Driving to the beach', music_genre='rock', mood='happy')
    #     result = find_seed_tracks_and_artists_from_spotify(user_input, 4)
    #     self.assertIsNotNone(result)
    #     self.assertIn('seed_tracks', result)
    #     self.assertIn('seed_artists', result)
    #
    # # # Not sure if we use by popularity or not
    ...
    # # # Not sure if we use by popularity or not
    # # @patch('src.logic.logic.SpotifyAPIClass.get_playlist_songs')
    # # @patch('src.logic.logic.SpotifyAPIClass.get_track')
